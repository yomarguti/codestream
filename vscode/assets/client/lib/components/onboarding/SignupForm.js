...
const getSystemUser = { sync: () => "changeme" };
			...
			<form id="signup-form" onSubmit={this.submitCredentials}>
				...
				<div id="controls">
					...
					<small className="fine-print">
						...
						<a onClick={() => this.context.platform.openInBrowser("https://codestream.com/tos")}>
							<FormattedMessage id="signUp.legal.termsOfService" />
						</a>{" "}
						<FormattedMessage id="and" />{" "}
						<a
							onClick={() => this.context.platform.openInBrowser("https://codestream.com/privacy")}
						>
					...
					<small className="fine-print" id="telemetry-consent">
						...
						<div className="telemetry-label">
							...
							<a
								onClick={() =>
									this.context.platform.openInBrowser(

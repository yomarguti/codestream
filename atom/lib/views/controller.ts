...
import { DidChangeVersionCompatibilityNotification, VersionCompatibility } from "protocols/agent/agent.protocol.notifications";
...
export class ViewController implements Disposable {
  ...
  getMainView() {
    ...
    this.subscriptions.add(
      ...
      Container.session.agent.onDidChangeVersionCompatibility((e: DidChangeVersionCompatibilityNotification) => {
        this.session.versionCompatibility = e.compatibility;
        if (Container.viewController && Container.viewController.mainView) {
          Container.viewController.mainView.changeVersionCompatibility(e);
        }
      }),

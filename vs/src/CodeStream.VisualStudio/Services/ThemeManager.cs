    ...
    public static class ThemeManager
    {
        ...
        public static ThemeInfo Generate()
        {
            ...
            if (isDark)
            {
                ...
                colorInfos.Add(new ColorInfo { Key = "link-color", VisualStudioKey = EnvironmentColors.ToolWindowButtonDownColorKey });
            ...
            else
            {
                ...
                colorInfos.Add(new ColorInfo { Key = "text-color-subtle", VisualStudioKey = EnvironmentColors.ToolWindowButtonInactiveColorKey, Modifier = (b) => b.ToArgb(60) });

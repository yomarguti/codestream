...
namespace CodeStream.VisualStudio
{
    ...
    internal sealed class CodeStreamDebugCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("52c750a2-e314-459c-9f92-1afb5c2daaef");
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            ToolWindowPane window = package.FindToolWindow(typeof(CodeStreamDebug), 0, true);

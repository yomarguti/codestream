...
// 	UsersRTMessage
// } from "../apiProvider";
// import { MSTeamsApiProvider } from "./teamsApi";
// import { fromSlackChannelIdToType, fromSlackPost } from "./teamsApi.adapters";
...
// export class TeamsEvents implements Disposable {
...
// 	constructor(
// 		slackToken: string,
// 		private readonly _api: MSTeamsApiProvider,
...
// 	@log({
// 		prefix: (context, e: TeamsEvent) =>
// 			`${context.prefix}(${e.type}${e.subtype ? `:${e.subtype}` : ""})`
// 	})
// 	private async onSlackChannelChanged(e: TeamsEvent) {
// 		const cc = Logger.getCorrelationContext();
// 		const { type } = e;
...
// 			`${context.prefix}(${e.type}${e.subtype ? `:${e.subtype}` : ""})`
// 	})
// 	private async onSlackMessageChanged(e: TeamsEvent) {
// 		const cc = Logger.getCorrelationContext();
...
// 	@log({
// 		prefix: (context, e: TeamsEvent) => `${context.prefix}(${e.type})`
// 	})
// 	private async onSlackUserChanged(e: TeamsEvent) {
// 		const cc = Logger.getCorrelationContext();
// 		const { type } = e;

...
export const ChangesetFile = styled((props: ReviewChangesetFileInfo & { className?: string }) => {
	return (
		<div className={`${props.className} row-with-icon-actions monospace ellipsis-left-container`}>
